...
<template>
  <q-dialog ref="dialogRef" maximized @hide="onDialogHide">
    <q-card>
      <q-bar>
        <q-btn class="q-mr-sm" dense flat push icon="refresh" @click="getReportSchedules" />Report
        Schedules
        <q-space />
      ...
      >
        ...
        <template #body="props">
          <q-tr :props="props" class="cursor-pointer" @dblclick="openEditSchedule(props.row)">
            <!-- Context Menu -->
            <q-menu context-menu>
              <q-list dense style="min-width: 200px">
                ...
                <q-item v-close-popup clickable @click="openEditSchedule(props.row)">
                  <q-item-section>Edit</q-item-section>
                </q-item>

                <q-item v-close-popup clickable @click="openCloneSchedule(props.row)">
                  <q-item-section>Clone</q-item-section>
                </q-item>

                <q-item v-close-popup clickable @click="deleteSchedule(props.row)">
