    ...
    <q-card class="q-dialog-plugin" style="width: 90vw; max-width: 600px">
      ...
      <q-form @submit.prevent="submit">
        ...
        <q-card-section v-if="localSchedule.schedule_type === 'weekly'">
          <!-- day of week input -->
          Run on Days:
          <span v-if="dayOfWeekValidationError" class="text-negative">*Required</span>
          <q-option-group
        ...
        <!-- monthly options -->
        <q-card-section v-if="localSchedule.schedule_type === 'monthly'" class="row">
          ...
          >
            <template #before-options>
              <q-item>
                ...
                <q-item-section side>
                  <q-checkbox v-model="allMonthsCheckbox" dense @update:model-value="toggleMonths" />
                </q-item-section>
              </q-item>
            </template>
