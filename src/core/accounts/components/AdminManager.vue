          ...
          <q-tr :props="props" class="cursor-pointer" @dblclick="showEditUserModal(props.row)">
            ...
            <q-menu context-menu>
              <q-list dense style="min-width: 200px">
                ...
                <q-item clickable v-close-popup @click="showSessions(props.row)" id="context-reset">
                  <q-item-section side>
                    <q-icon name="groups" />
                  </q-item-section>
            ...
            <q-td>
              <q-chip v-if="props.row.social_accounts.length > 0" color="primary" dense>SSO</q-chip>
            </q-td>
