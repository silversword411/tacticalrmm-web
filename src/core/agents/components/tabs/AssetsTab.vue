<template>
  ...
  <div v-else-if="agentStore.selectedAgentPlatform !== 'windows'" class="q-pa-sm">
  ...
  <div v-else>
    ...
    <q-tab-panels v-model="tab">
      <q-tab-panel name="os">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.os" />
      </q-tab-panel>
      <q-tab-panel name="cpu">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.cpu" />
      </q-tab-panel>
      <q-tab-panel name="mem">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.mem" />
      </q-tab-panel>
      <q-tab-panel name="usb">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.usb" />
      </q-tab-panel>
      <q-tab-panel name="bios">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.bios" />
      </q-tab-panel>
      <q-tab-panel name="disk">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.disk" />
      </q-tab-panel>
      <q-tab-panel name="comp_sys">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.comp_sys" />
      </q-tab-panel>
      <q-tab-panel name="base_board">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.base_board" />
      </q-tab-panel>
      <q-tab-panel name="comp_sys_prod">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.comp_sys_prod" />
      </q-tab-panel>
      <q-tab-panel name="network_config">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.network_config" />
      </q-tab-panel>
      <q-tab-panel name="desktop_monitor">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.desktop_monitor" />
      </q-tab-panel>
      <q-tab-panel name="graphics">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.graphics" />
      </q-tab-panel>
      <q-tab-panel name="network_adapter">
        <WmiDetail :info="agentStore.selectedAgent?.wmi_detail?.network_adapter" />
      </q-tab-panel>
    </q-tab-panels>
  </div>
</template>
