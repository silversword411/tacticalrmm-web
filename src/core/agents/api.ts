...
export const useAgentStore = defineStore("agents", () => {
  ...
  const meshCentralURLs = ref<any>(null);
  const webVNCUrl = ref<string | null>(null);
  ...
  function installAgentSoftware(agent_id: string, payload) {
    isLoading.value = true;
    isError.value = false;
    axios
      .post(`/software/${agent_id}/`)
      .then(() => {
  ...
  function updateAgentService(agent_id: string, svcname: string, startType: AgentServiceStartType) {
    axios
